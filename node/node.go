...
func (n *Node) Start() error {
	n.lock.Lock()
	defer n.lock.Unlock() //defer是在return之前执行的 =..=
	...
	// Changed to in case of ErrDatadirUsed, Kame Wang 20180619
	/*
	...
	/********* Change by Kame Wang
	// Changed by kame wang. This comment mark will disable all the code unrelated to P2P node detector.
